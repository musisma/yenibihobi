...
import com.example.yenibihobi.activities.LoginRegisterActivity
import com.example.yenibihobi.databinding.FragmentProfileBinding
import com.example.yenibihobi.util.Resource
import com.example.yenibihobi.util.showBottomNavigationView
import com.example.yenibihobi.viewmodel.ProfileViewModel
...
class ProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvVersion.text = "Mustafa İsmail Öztürk \n 2023 \n Version ${com.google.firebase.BuildConfig.VERSION_NAME}"
