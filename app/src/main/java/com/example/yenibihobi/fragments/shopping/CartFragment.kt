...
import com.example.yenibihobi.adapters.CartProductAdapter
import com.example.yenibihobi.databinding.FragmentCartBinding
import com.example.yenibihobi.firebase.FirebaseCommon
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.deleteDialog.collectLatest {
                val alertDialog = AlertDialog.Builder(requireContext()).apply {
                    setTitle("Ürünü sepetten sil")
                    setMessage("Seçili ürünü sepetten silmek istiyor musunuz?")
